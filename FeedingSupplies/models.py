...
# FeedingSupplies object
class FeedingSupplies(models.Model):
    ...
    image = models.ImageField(upload_to='all_feeding_supplies_images')
    ...
    class Meta:
        ...
        verbose_name_plural = 'All Feeding Supplies'

    # Function to return the feeding supplies title in admin portal
    def __str__(self):
        return self.title
